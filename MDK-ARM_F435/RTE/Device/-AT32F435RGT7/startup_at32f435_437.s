...
Reset_Handler   PROC
                ...
                IMPORT  __main
                IMPORT  SystemInit
                IMPORT  extend_sram_512k
                ; Ensure EOPB0 = 512K SRAM before any RAM init (resets inside
                ; if reconfigured). Only the MSP stack (low 384K) is usable here.
                LDR     R0, =extend_sram_512k
                BLX     R0
                LDR     R0, =SystemInit
                BLX     R0
                LDR     R0, =__main
