...
extern "C" {
#define IMPORT_MONTSERRAT(name) \
do{\
    LV_FONT_DECLARE(lv_font_##name)\
    Font_.AddResource(#name, (void*)&lv_font_##name);\
}while(0)	
...
do{\
    ...
    {
        /* Import Fonts */
        IMPORT_MONTSERRAT(montserrat_8);
        IMPORT_MONTSERRAT(montserrat_10);
        IMPORT_FONT(bahnschrift_13);
        IMPORT_FONT(bahnschrift_17);
        IMPORT_FONT(bahnschrift_32);
        IMPORT_FONT(bahnschrift_48);
        IMPORT_FONT(bahnschrift_65); 
		IMPORT_FONT(bahnschrift_24);
        IMPORT_FONT(cn_16);
        IMPORT_FONT(iconfont_16);
        IMPORT_FONT(iconfont_20);
	    IMPORT_FONT(agencyb_12);
